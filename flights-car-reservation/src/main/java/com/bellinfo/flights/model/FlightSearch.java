...
public class FlightSearch {
    ...
    private static final String API_KEY = "AIzaSyAnEZOPPz2uubTk3yQHcEi9THqcPVvzigY";
                  ...
                  for(int j=0; j<sliceInfo.size(); j++){
                      ...
                      for(int k=0; k<segInfo.size(); k++){
                          ...
                          for(int l=0; l<leg.size(); l++){
                              ...
                              fd.setArrivalTime(arrivalTime.substring(11,16));
                              String departTime=leg.get(l).getDepartureTime();
                              fd.setDepartTime(departTime.substring(11,16));
