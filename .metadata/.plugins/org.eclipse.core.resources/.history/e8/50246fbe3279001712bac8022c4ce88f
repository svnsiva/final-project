...
<div class="container col-sm-offset-4">
				<div class="row">
					...
					<div class="bt">
							<a href="http://localhost:8080/flights-car-reservation/search?Round=RoundTrip&depart=&Return="><button type="button" class="btn btn-success">Flights</button></a>
							<a href=""><button type="button" class="btn btn-success">Cars</button></a>
							<a href=""><button type="button" class="btn btn-success">Flights + Cars</button></a>
							</div>
							<br>
						<div class="tabing">
							...
							<div class="tab-content">
								<div id="1" class="tab1 active">
									...
									<form action="${pageContext.request.contextPath}/flights-car-reservation/search" method="POST">
